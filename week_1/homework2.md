...
Terraform will perform the following actions:
  ...
  + resource "google_bigquery_dataset" "dataset" {
      ...
      + project                    = "booming-landing-375221"
  ...
  + resource "google_storage_bucket" "data-lake-bucket" {
      ...
      + id                          = (known after apply)
      + location                    = "EUROPE-WEST6"
      + name                        = "de-zoomcamp-2023_booming-landing-375221"
...
google_storage_bucket.data-lake-bucket: Creation complete after 2s [id=de-zoomcamp-2023_booming-landing-375221]
google_bigquery_dataset.dataset: Creation complete after 3s [id=projects/booming-landing-375221/datasets/ny_taxi_trips]

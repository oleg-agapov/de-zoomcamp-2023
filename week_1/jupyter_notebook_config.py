...
#  password.
#  Default: ''
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$EgJfxgMniVLLo8Ap27sFSg$qBoUQZ6KfslOvRMNz5RLrRh31WvPd5+s9WHov74hgaM'
...
#  Choices: any of ['blake2s', 'sha224', 'sha3_256', 'blake2b', 'sha3_224', 'sha384', 'md5', 'sha256', 'sha512', 'sha1', 'sha3_384', 'sha3_512']
#  Default: 'sha256'
